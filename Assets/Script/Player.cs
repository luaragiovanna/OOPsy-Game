...
{
    private Animator anime; //componente para animação
    private NavMeshAgent agent; //componente para movimentação
    private Camera cinemachineCamera; //camera principal

    public Text dialogueText;
    [SerializeField] private GameObject dialogueBackground; // barra branca que aparece como fundo das falas
    ...
    void Start()
    {
        ...
        if (dialogueManager != null)
        {
            ...
            dialogueManager.StartDialogue(initialDialogues);//inicia aqui 
        }
        else
        {
